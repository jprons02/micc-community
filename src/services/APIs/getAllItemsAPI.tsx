...
export const getAllItemsAPI = async (tableName: string) => {
  const response = await fetch(
    `https://p70xq17396.execute-api.us-east-1.amazonaws.com/prod/DynamoDB/get-all-items/?TableName=${tableName}`,
    {
      method: 'GET',
      headers: {
        'x-api-key': keys.dynamoAPI,
